...
def Prediction2():
    ...
    if gender == "male":
        gender = 0
    mybmidata = pd.read_csv(r"C:\Users\Lenovo\PycharmProjects\Disease_Prediction\bmi_male_female.csv")
...
def Prediction3():
    ...
    mydata = pd.read_csv(r"C:\Users\Lenovo\PycharmProjects\Disease_Prediction\SymptomsDataset.csv")
...
def Prediction4():
    ...
    mydata = pd.read_csv(r'C:\Users\Lenovo\PycharmProjects\Disease_Prediction\pima-diabetes.csv')
...
def Prediction():
    ...
    mydata = pd.read_csv(r"C:\Users\Lenovo\PycharmProjects\Disease_Prediction\indian_liver_patient.csv")
